          ...
          <table width="600" cellpadding="20" cellspacing="0" style="background-color: #ffffff; margin-top: 30px; border-radius: 8px;">
            ...
            <tr>
              <td style="font-size: 14px; color: #333;">
                Bonjour,<br /><br />
                Nous avons reçu une demande de réinitialisation de mot de passe pour votre compte <strong>BRICOLA</strong>. Si vous êtes à l'origine de cette demande,saisissez le code ci-dessous pour créer un nouveau mot de passe :
              </td>
            </tr>
            <tr>
              <td align="center">
